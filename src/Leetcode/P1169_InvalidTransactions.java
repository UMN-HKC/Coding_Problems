...
public class P1169_InvalidTransactions {

    // approach 1: sort + two pointers
    // the basic idea is to use hashmap to map customer to the list of all his/her
    // transactions. For those list, sort list by time so that we can use two
    // pointers technique to check time conflict for same customer between different
    // cities in terms of transaction time.
